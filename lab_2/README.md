...
1. Результати виконання завдання viii - "Знайомство з `lambdas`" :
    1. Ми використали *Лямбду* для обчислення квадрату числа 5. За допомогою *Лямбди* ми можемо з простого слова зробити функцію, яку ми викликаємо для виконання дії. Це ми і зробили для слова *square*.
